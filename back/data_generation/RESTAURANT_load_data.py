...
while True:  # loop to get more results until next_page is not None
    for place in places:
        ...
        image_url = f'https://maps.googleapis.com/maps/api/place/photo?maxwidth=1600&maxheight=1600&photo_reference={photo_reference}&key={API_KEY}'  # url google API to get the photo of a restaurant
