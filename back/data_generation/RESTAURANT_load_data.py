...
while True:  # loop to get more results until next_page is not None
    for place in places:
        ...
        url = f'https://maps.googleapis.com/maps/api/place/details/json?place_id={place_id}&language=es-419&key={API_KEY}'  # url google API with the details of a restaurant
        response = requests.get(url)
