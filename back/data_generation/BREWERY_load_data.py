...
while True:
    for place in places:
        ...
        url = f'https://maps.googleapis.com/maps/api/place/details/json?place_id={place_id}&language=es-419&key={API_KEY}'  # url google API with the details of a brewery
        response = requests.get(url)
