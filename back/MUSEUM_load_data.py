...
url = f'https://maps.googleapis.com/maps/api/place/textsearch/json?query=Museos%20en%20Montevideo%20Uruguay&key={API_KEY}' # url google API with the search of museums in Montevideo
