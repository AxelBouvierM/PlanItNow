...
url = f'https://maps.googleapis.com/maps/api/place/textsearch/json?query=sitios+de+entrenimiento+familiar+en+Montevideo+Uruguay&key={API_KEY}' # url google API with the search of entertainment palces in Montevideo
